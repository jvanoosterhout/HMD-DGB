...
- Fixed the published-release verification workflow by separating the repository checkout action from release-asset download commands.
- Fixed release-asset verification to import the installed wheel and source distribution instead of the checked-out source tree.

## [1.0.0b3] - 2026-08-30

### Fixed

- Fixed published-release asset verification by checking out the repository before downloading release artifacts.
