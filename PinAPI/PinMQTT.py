...
class Pin_mqtt:
    ...
    def config_brokker(self):
        ...
        self.client.will_set("sys/{}/status".format(self.name), payload="offline", qos=0, retain=True)
    ...
    def config_system_sensors(self):
        ...
        self.cpu_temp_sensor = sensors.Sensor(Settings(mqtt=self.mqtt_settings, entity=cpu_temp_info))
        self.up_time_sensor = sensors.Sensor(Settings(mqtt=self.mqtt_settings, entity=up_time_info))
